...
export default function App() {
  ...
  },
  {
      ...
      year: 2014,
      calification: 9.6,
      sinopsis: "Interstellar sigue a Cooper, un ex piloto de la NASA que se une a una misión espacial para encontrar un nuevo hogar para la humanidad...",
      clasificación: "PG-13",
      reseña: [
          {
  ...
  return (
    ...
    <MainStack peliculas={peliculas} setPeliculas={setPeliculas}/>
  );
}
